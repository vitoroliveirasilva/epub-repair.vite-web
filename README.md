...
Ferramenta **front-end estática** para validar, reparar e reempacotar arquivos `.epub` diretamente no navegador, com objetivo em aumentar a compatibilidade com fluxos de envio/upload para Kindle.

O projeto não possui backend, banco de dados nem integração com APIs externas, portanto, o EPUB é carregado, analisado, reparado e baixado localmente no navegador do usuário.
